...
class CourseDetailActivity: AppCompatActivity(){
    ...
    private fun fetchJSON() {
        ...
        client.newCall(request).enqueue(object: Callback{
            override fun onResponse(call: Call?, response: Response?) {
                ...
                val courseLessons = gson.fromJson(body, kotlin.Array<CourseLesson>::class.java)
    ...
    private class CourseDetailAdapter(val courseLessons: kotlin.Array<CourseLesson>): RecyclerView.Adapter<CourseLessonViewHolder>(){
 ...
 //           blueView.minimumHeight = 50
        ...
        override fun onBindViewHolder(holder: CourseLessonViewHolder?, position: Int) {
            ...
            holder?.customView?.textView3_duration?.text = courseLesson.duration
